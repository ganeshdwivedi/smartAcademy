...
const GetToKnow = () => {
    return (
        <div className='flex lg:flex-row overflow-hidden lg:items-start items-center justify-center flex-col my-10 lg:m-28'>

            <div className='lg:w-[40vw] mx-10 relative'>
                <RectangleSvg className={"-top-10 -left-10"} />
                <h3 className='text-sm my-2 font-bold text-purple-700'>
                    Get to know about us
                </h3>
                <h3 className='capitalize text-[#333333] text-[30px] lg:text-[34px] font-extrabold'>Discover Top instructors around the world</h3>
                ...
                <div className='grid grid-cols-2 gap-x-3 gap-y-10 my-5'>
                    ...
                    <div className='flex flex-row items-center relative'>
                        <Person />
                        <DiamondRub color={"#DBDBDB"} className={"-left-2 top-0"} />
                        <div className='mx-5'>
                    ...
                    <div className='flex flex-row items-center relative'>
                        <Book />
                        <DiamondRub color={"#F0B5CB"} className={"-left-2 top-0"} />
                        <div className='mx-5'>
                    ...
                    <div className='flex flex-row items-center relative'>
                        <Student />
                        <DiamondRub color={"#96A5C3"} className={"-left-2 top-0"} />
                        <div className='mx-5'>
                    ...
                    <div className='flex flex-row items-center relative'>
                        <VideoSvg />
                        <DiamondRub color={"#9AAEDF"} className={"-left-2 top-0"} />
                        <div className='mx-5'>
            ...
            <Slide direction='right' triggerOnce={true}>
                <div className='lg:w-[30vw] mt-5 mx-20 lg:mr-20 flex-row flex gap-2 relative'>
                    <RobotSvg className={"bottom-[18rem] -left-0"} />
                    <div className='flex flex-col gap-2 relative'>
                        ...
                        <div className='w-[300px] h-[90px]'> <img className='w-full h-full rounded-bl-2xl object-top object-cover' src="https://s3-alpha-sig.figma.com/img/ffc1/62d0/8c470285ac8081f7f560b825b1bf3523?Expires=1705276800&Signature=LuZSAdICTOoGPlI-bH-BEz~vWc6X35OZihiExheF1XkEtRG2EC1PAlKPUWOVWAe7SLf81BhCqJILxW9o7wsLKnBbCxYi6MGK9Bi4-YtMtmjPAsB6PrzPwPQsRibcMW6KxhQxrc4rUROkU1CsLYt1DWN4IJGr~nMoPo-PwJ9PQMeWo3oNuwhJMgUyeQrFEEPZbMAoO6vjuKWULy4eGKlkQRyeYvVvVWrwKeq~3oqNhJ9LqKgBSprEC3GUt64PmPHZAyUmihp6w0u91sEVI6Zvl02nr0bDpXwebaBvgureMOfC5-FSE~pf6pOuMyTlMV49fy75H-Ro5ygJMq37czgG1w__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" /></div>

                    </div>
                    <div className='flex flex-col gap-2 absolute left-[9.5rem]'>
